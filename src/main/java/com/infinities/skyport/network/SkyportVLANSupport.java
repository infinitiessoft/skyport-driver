 ...
 *
 */
public interface SkyportVLANSupport {

	ServiceAction ANY = new ServiceAction("NET:ANY");

	ServiceAction ADD_ROUTE = new ServiceAction("NET:ADD_ROUTE");
	ServiceAction ASSIGN_ROUTE_TO_SUBNET = new ServiceAction("NET:ASSIGN_ROUTE_TO_SUBNET");
	ServiceAction ASSIGN_ROUTE_TO_VLAN = new ServiceAction("NET:ASSIGN_ROUTE_TO_VLAN");
	ServiceAction ATTACH_INTERNET_GATEWAY = new ServiceAction("NET:ATTACH_INTERNET_GATEWAY");
	ServiceAction CREATE_ROUTING_TABLE = new ServiceAction("NET:CREATE_ROUTING_TABLE");
	ServiceAction CREATE_INTERNET_GATEWAY = new ServiceAction("NET:CREATE_INTERNET_GATEWAY");
	ServiceAction GET_ROUTING_TABLE = new ServiceAction("NET:GET_ROUTING_TABLE");
	ServiceAction LIST_ROUTING_TABLE = new ServiceAction("NET:LIST_ROUTING_TABLE");
	ServiceAction REMOVE_INTERNET_GATEWAY = new ServiceAction("NET:REMOVE_INTERNET_GATEWAY");
	ServiceAction REMOVE_ROUTE = new ServiceAction("NET:REMOVE_ROUTE");
	ServiceAction REMOVE_ROUTING_TABLE = new ServiceAction("NET:REMOVE_ROUTING_TABLE");

	ServiceAction ATTACH_NIC = new ServiceAction("NET:ATTACH_NIC");
	ServiceAction CREATE_NIC = new ServiceAction("NET:CREATE_NIC");
	ServiceAction DETACH_NIC = new ServiceAction("NET:DETACH_NIC");
	ServiceAction GET_NIC = new ServiceAction("NET:GET_NIC");
	ServiceAction LIST_NIC = new ServiceAction("NET:LIST_NIC");
	ServiceAction REMOVE_NIC = new ServiceAction("NET:REMOVE_NIC");

	ServiceAction CREATE_SUBNET = new ServiceAction("NET:CREATE_SUBNET");
	ServiceAction CREATE_VLAN = new ServiceAction("NET:CREATE_VLAN");
	ServiceAction GET_SUBNET = new ServiceAction("NET:GET_SUBNET");
	ServiceAction GET_VLAN = new ServiceAction("NET:GET_VLAN");
	ServiceAction LIST_SUBNET = new ServiceAction("NET:LIST_SUBNET");
	ServiceAction LIST_VLAN = new ServiceAction("NET:LIST_VLAN");
	ServiceAction REMOVE_SUBNET = new ServiceAction("NET:REMOVE_SUBNET");
	ServiceAction REMOVE_VLAN = new ServiceAction("NET:REMOVE_VLAN");
	 ...
	 *             route
	 */
	Route addRouteToAddress(@Nonnull String routingTableId, @Nonnull IPVersion version, @Nullable String destinationCidr,
			@Nonnull String address) throws CloudException, InternalException;
	 ...
	 *             route
	 */
	Route addRouteToGateway(@Nonnull String routingTableId, @Nonnull IPVersion version, @Nullable String destinationCidr,
			@Nonnull String gatewayId) throws CloudException, InternalException;
	 ...
	 *             route
	 */
	Route addRouteToNetworkInterface(@Nonnull String routingTableId, @Nonnull IPVersion version,
	 ...
	 *             route
	 */
	Route addRouteToVirtualMachine(@Nonnull String routingTableId, @Nonnull IPVersion version,
			@Nullable String destinationCidr, @Nonnull String vmId) throws CloudException, InternalException;

	/**
	 * Indicates that users may self-provision network interfaces. If false,
	 * either network interfaces are not supported or they cannot be
	 * self-provisioned
	 * 
	 * @return true if users can self-provision network interfaces
	 * @throws CloudException
	 *             an error occurred checking with the cloud if network
	 *             interfaces may be self provisioned
	 * @throws InternalException
	 *             an error occurred in the Dasein Cloud implementation
	 *             determining support
	 * @deprecated use
	 *             {@link VLANCapabilities#allowsNewNetworkInterfaceCreation()}
	 */
	@Deprecated
	 ...
	 * @throws CloudException
	 *             an error occurred checking with the cloud for support
	 * @throws InternalException
	 *             an error occurred in the Dasein Cloud implementation
	 *             determining support
	 * @deprecated use
	 *             {@link VLANCapabilities#allowsMultipleTrafficTypesOverSubnet()}
	 */
	@Deprecated
	 ...
	 *             determining support
	 * @deprecated use
	 *             {@link VLANCapabilities#allowsMultipleTrafficTypesOverVlan()}
	 */
	@Deprecated
	 ...
	 */
	void assignRoutingTableToSubnet(@Nonnull String subnetId, @Nonnull String routingTableId) throws CloudException,
			InternalException;
	 ...
	 *             a local error occurred while processing the request
	 */
	void disassociateRoutingTableFromSubnet(@Nonnull String subnetId, @Nonnull String routingTableId) throws CloudException,
			InternalException;
	 ...
	 *             a local error occurred while processing the request
	 */
	void assignRoutingTableToVlan(@Nonnull String vlanId, @Nonnull String routingTableId) throws CloudException,
			InternalException;
	 ...
	 */
	String attachNetworkInterface(@Nonnull NICAttachOptions options) throws CloudException, InternalException;
	 ...
	 */
	@Nullable
	String createInternetGateway(@Nonnull String vlanId) throws CloudException, InternalException;
	 ...
	 */
	@Nonnull
	String createRoutingTable(@Nonnull String vlanId, @Nonnull String name, @Nonnull String description)
	...
	/**
	 * Provisions a subnet in the specified VLAN using the specified address
	 * space.
	 * 
	 * @param cidr
	 *            the CIDR of the address space within the target VLAN that will
	 *            be used for the subnet
	 * @param inProviderVlanId
	 *            the provider ID for the VLAN being subnetted
	 * @param name
	 *            the name of the subnet
	 * @param description
	 *            a description of the purpose of the subnet
	...
	@Deprecated
	@Nonnull
	Subnet createSubnet(@Nonnull String cidr, @Nonnull String inProviderVlanId, @Nonnull String name,
	...
	@Nonnull
	VLAN createVlan(@Nonnull String cidr, @Nonnull String name, @Nonnull String description, @Nonnull String domainName,
	 ...
	 */
	@Nonnull
	VLAN createVlan(@Nonnull VlanCreateOptions options) throws InternalException, CloudException;
	 ...
	 * 
	 * @param options
	 *            the options to be used in detaching the network interface
	 * @throws CloudException
	 ...
	 */
	void detachNetworkInterface(@Nonnull NICDetachOptions options) throws CloudException, InternalException;
	...
	/**
	 * Specifies the maximum number of network interfaces that may be
	 * provisioned.
	 * 
	 * @return the maximum number of network interfaces that may be provisioned
	 *         or -1 for no limit or -2 for unknown
	 * @throws CloudException
	 *             an error occurred requesting the limit from the cloud
	 *             provider
	 * @throws InternalException
	 *             a local error occurred figuring out the limit
	 ...
	 * 
	 * @param locale
	 *            the locale in which the term should be provided
	 * @return a localized term for "network interface" specific to this cloud
	 *         provider
	 * @deprecated use
	 *             {@link VLANCapabilities#getProviderTermForNetworkInterface(java.util.Locale)}
	 */
	@Deprecated
	@Nonnull
	 ...
	 */
	@Nullable
	NetworkInterface getNetworkInterface(@Nonnull String nicId) throws CloudException, InternalException;
	 ...
	 */
	@Nullable
	RoutingTable getRoutingTableForSubnet(@Nonnull String subnetId) throws CloudException, InternalException;

	/**
	 * Indicates whether or not you may or must manage routing tables for your
	 * VLANs/subnets.
	 * 
	 * @return the level of routing table management that is required
	 * @throws CloudException
	 *             an error occurred in the cloud provider determining support
	 * @throws InternalException
	 *             a local error occurred processing the request
	 ...
	 */
	@Nullable
	RoutingTable getRoutingTableForVlan(@Nonnull String vlanId) throws CloudException, InternalException;
	 ...
	 */
	@Nullable
	RoutingTable getRoutingTable(@Nonnull String id) throws CloudException, InternalException;

	@Nullable
	Subnet getSubnet(@Nonnull String subnetId) throws CloudException, InternalException;

	/**
	 * Indicates whether subnets in VLANs are required, optional, or not
	 * supported.
	 * 
	 * @return the level of support for subnets in this cloud
	 * @throws CloudException
	 *             an error occurred in the cloud while determining the support
	 *             level
	 * @throws InternalException
	 *             a local error occurred determining subnet support level
	...
	@Nullable
	VLAN getVlan(@Nonnull String vlanId) throws CloudException, InternalException;

	/**
	 * Indicates whether or not you must specify a data center when provisioning
	 * your subnet. If {@link Requirement#NONE}, then the cloud has no support
	 * for data centers and/or subnets or it lacks the ability to provision
	 * subnets in specific data centers. {@link Requirement#OPTIONAL} means that
	 * the cloud supports both and you may or may not specify a data center. No
	 * cloud should ever return {@link Requirement#REQUIRED}. Even if the cloud
	 * requires it, the Dasein Cloud implementation should pick on the client's
	 * request when none is specified.
	 * 
	 * @return the requirements for specifying a data center when provisioning a
	 *         subnet
	 * @throws CloudException
	 *             an error occurred with the cloud provider determining support
	 *             for this functionality
	 * @throws InternalException
	 *             a local error occurred determining support for this
	 *             functionality
	 ...
	 * VLAN is not connected to the Internet, it just means that, if it is
	 * connected, it's not connected via an Internet Gateway.
	 * 
	 * @param vlanId
	 *            the VLAN you are checking
	 * @return <code>true</code> if the VLAN is connected to the Internet via an
	 *         Internet Gateway
	 * @throws CloudException
	 ...
	 */
	boolean isConnectedViaInternetGateway(@Nonnull String vlanId) throws CloudException, InternalException;
	 ...
	 */
	@Nonnull
	Iterable<String> listFirewallIdsForNIC(@Nonnull String nicId) throws CloudException, InternalException;
	 ...
	 */
	@Nonnull
	Iterable<InternetGateway> listInternetGateways(@Nullable String vlanId) throws CloudException, InternalException;
	 ...
	 */
	@Nonnull
	Iterable<NetworkInterface> listNetworkInterfacesInSubnet(@Nonnull String subnetId) throws CloudException,
			InternalException;
	 ...
	 */
	@Nonnull
	Iterable<Networkable> listResources(@Nonnull String vlanId) throws CloudException, InternalException;
	 ...
	 */
	@Nonnull
	Iterable<RoutingTable> listRoutingTablesForSubnet(@Nonnull String subnetId) throws CloudException, InternalException;
	...
	@Deprecated
	@Nonnull
	Iterable<RoutingTable> listRoutingTables(@Nonnull String vlanId) throws CloudException, InternalException;
	 ...
	 */
	@Nonnull
	Iterable<RoutingTable> listRoutingTablesForVlan(@Nonnull String vlanId) throws CloudException, InternalException;
	 ...
	 */
	@Nonnull
	Iterable<Subnet> listSubnets(@Nullable String vlanId) throws CloudException, InternalException;
	 ...
	 * @throws CloudException
	 *             an error occurred checking support for IP versions with the
	 *             cloud provider
	 * @throws InternalException
	 *             a local error occurred preparing the supported version
	 ...
	 *             cloud
	 */
	void removeInternetGateway(@Nonnull String forVlanId) throws CloudException, InternalException;
	 ...
	 *             cloud
	 */
	void removeInternetGatewayById(@Nonnull String id) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void removeInternetGatewayTags(@Nonnull String internetGatewayId, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void removeInternetGatewayTags(@Nonnull String[] internetGatewayIds, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 */
	void removeNetworkInterface(@Nonnull String nicId) throws CloudException, InternalException;
	 ...
	 */
	void removeRoute(@Nonnull String routingTableId, @Nonnull String destinationCidr) throws CloudException,
			InternalException;
	 ...
	 */
	void removeRoutingTable(@Nonnull String routingTableId) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void removeRoutingTableTags(@Nonnull String routingTableId, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void removeRoutingTableTags(@Nonnull String[] routingTableIds, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 */
	void removeSubnet(String providerSubnetId) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void removeSubnetTags(@Nonnull String subnetId, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void removeSubnetTags(@Nonnull String[] subnetIds, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void setSubnetTags(@Nonnull String subnetId, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void setSubnetTags(@Nonnull String[] subnetIds, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 */
	void removeVlan(String vlanId) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void removeVLANTags(@Nonnull String vlanId, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void removeVLANTags(@Nonnull String[] vlanIds, @Nonnull Tag... tags) throws CloudException, InternalException;

	/**
	 * Indicates whether or not this cloud allows enabling of internet gateways
	 * for VLANs. This is not relevant if all VLANs are Internet routable or if
	 * they simply cannot be made routable.
	 * 
	 * @return true if this cloud supports the optional enablement of Internet
	 *         gateways for VLANS, false if all VLANs are either always or never
	 *         Internet routable
	 * @throws CloudException
	 *             an error occurred determining this capability from the cloud
	 *             provider
	 * @throws InternalException
	 *             a local error occurred determining this capability
	 * @deprecated use
	 *             {@link VLANCapabilities#supportsInternetGatewayCreation()}
	 */
	@Deprecated
	boolean supportsInternetGatewayCreation() throws CloudException, InternalException;

	/**
	 * Indicates whether you can specify a raw IP address as a target for your
	 * routing table.
	 * 
	 * @return true if you can specify raw addresses, false if you need to
	 *         specify other resources
	 * @throws CloudException
	 *             an error occurred identifying support
	 * @throws InternalException
	 *             a local error occurred identifying support
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void updateSubnetTags(@Nonnull String subnetId, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void updateSubnetTags(@Nonnull String[] subnetIds, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void updateRoutingTableTags(@Nonnull String routingTableId, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void updateRoutingTableTags(@Nonnull String[] routingTableIds, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void setRoutingTableTags(@Nonnull String routingTableId, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void setRoutingTableTags(@Nonnull String[] routingTableIds, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void setVLANTags(@Nonnull String vlanId, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void setVLANTags(@Nonnull String[] vlanIds, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void updateVLANTags(@Nonnull String vlanId, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void updateVLANTags(@Nonnull String[] vlanIds, @Nonnull Tag... tags) throws CloudException, InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void updateInternetGatewayTags(@Nonnull String internetGatewayId, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void updateInternetGatewayTags(@Nonnull String[] internetGatewayIds, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void setInternetGatewayTags(@Nonnull String internetGatewayId, @Nonnull Tag... tags) throws CloudException,
			InternalException;
	 ...
	 *             an error occurred within the Dasein Cloud API implementation
	 */
	void setInternetGatewayTags(@Nonnull String[] internetGatewayIds, @Nonnull Tag... tags) throws CloudException,
			InternalException;
