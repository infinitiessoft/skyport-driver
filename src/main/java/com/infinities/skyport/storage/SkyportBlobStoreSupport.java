...
public interface SkyportBlobStoreSupport extends AccessControlledService {
	...
	@Nonnull
	Blob createBucket(@Nonnull String bucket, boolean findFreeName) throws InternalException, CloudException;

	FileTransfer download(@Nullable String bucket, @Nonnull String objectName, @Nonnull File toFile)
	...
	@Nullable
	Storage<org.dasein.util.uom.storage.Byte> getObjectSize(@Nullable String bucketName, @Nullable String objectName)
			throws InternalException, CloudException;
	...
	@Nonnull
	Iterable<Blob> list(@Nullable String bucket) throws CloudException, InternalException;
	...
	void move(@Nullable String fromBucket, @Nullable String objectName, @Nullable String toBucket)
			throws InternalException, CloudException;
	...
	@Nonnull
	String renameBucket(@Nonnull String oldName, @Nonnull String newName, boolean findFreeName)
			throws CloudException, InternalException;

	void renameObject(@Nullable String bucket, @Nonnull String oldName, @Nonnull String newName)
			throws CloudException, InternalException;

	@Nonnull
	Blob upload(@Nonnull File sourceFile, @Nullable String bucket, @Nonnull String objectName)
			throws CloudException, InternalException;
	...
	void copy(@Nullable String sourceBucket, @Nullable String sourceObject, @Nullable String targetBucket,
			@Nullable String targetObject) throws InternalException, CloudException;
	
	Map<String, String> getMetadata(String... strs) throws CloudException, InternalException;

	void setObjectTags(@Nonnull String bucketName, @Nonnull String objectName, @Nonnull Tag... tags) throws CloudException, InternalException;

	void setObjectTags(@Nonnull String bucketName, @Nonnull String[] objectNames, @Nonnull Tag... tags) throws CloudException, InternalException;

	void updateObjectTags(@Nonnull String bucketName, @Nonnull String objectName, @Nonnull Tag ... tags) throws CloudException, InternalException;
	
	void updateObjectTags(@Nonnull String bucketName, @Nonnull String[] objectNames, @Nonnull Tag ... tags) throws CloudException, InternalException; 
	
	void removeObjectTags(@Nonnull String bucketName, @Nonnull String objectName, @Nonnull Tag ... tags) throws CloudException, InternalException;
	
	void removeObjectTags(@Nonnull String bucketName, @Nonnull String[] objectNames, @Nonnull Tag ... tags) throws CloudException, InternalException; 
